<template>
  <div
    :class="['vue-tel-input-traleado', styleClasses, { disabled: disabled }]"
  >
    <div
    ...
    >
      <span class="vti__selection">
        ...
        <span v-if="true" class="vti__country-code">
    ...
    >
      ...
      >
        <div class="vti__dropdown-item-container">
          <div class="vti__dropdown-item-content">
            <div
              v-if="dropdownOptions.showFlags"
            ...
            <div
              ...
              v-if="dropdownOptions.showDialCodeInList"
            >
              +{{ pb.dialCode }}
            </div>
          </div>

          <span class="vti__country-name">{{ pb.name }}</span>
        </div>
      </li>
    </ul>
  </div>
